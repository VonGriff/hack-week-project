insert into groups (group_title, group_size, group_size_lower_limit, group_size_upper_limit, complexity_lower_limit, complexity_upper_limit, mechanisms) values ('Looking For Boardgame Group', 2, 3, 5, 2.4, 3.5, 'Deckbuilding, Engine Building');
insert into groups (group_title, group_size, group_size_lower_limit, group_size_upper_limit, complexity_lower_limit, complexity_upper_limit, mechanisms) values ('A group all about deck building!', 2, 3, 4, 1.9, 3.1, 'Deckbuilding');
